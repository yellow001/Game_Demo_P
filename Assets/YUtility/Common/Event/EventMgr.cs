...
namespace YUtility.Common.Event {
    public class EventMgr : Singleton<EventMgr> {
        ...
        static int m_EventIndex = 0;

        static Dictionary<int,TimeEvent> tEvents_up = new Dictionary<int, TimeEvent>();
        static List<int> rmTEvents_up = new List<int>();

        static Dictionary<int, TimeEvent> tEvents_fix = new Dictionary<int, TimeEvent>();
        static List<int> rmTEvents_fix = new List<int>();

        static Dictionary<int, TimeEvent> tEvents_late = new Dictionary<int, TimeEvent>();
        static List<int> rmTEvents_late = new List<int>();
        ...
        public void RemoveTimeEvent(int eventID) {
            ...
            if (tEvents_up.ContainsKey(eventID)) {
                tEvents_up[eventID].deltaTime = 0;
            ...
            if (tEvents_fix.ContainsKey(eventID)) {
                tEvents_fix[eventID].deltaTime = 0;
            ...
            if (tEvents_late.ContainsKey(eventID)) {
                tEvents_late[eventID].deltaTime = 0;
